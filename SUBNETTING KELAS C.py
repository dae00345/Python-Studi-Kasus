...
def output():
	...
	print("| >> Penyelesaian :                                     |")
	print("|-------------------------------------------------------|")
	print("|                >> Hasil = ",ipOktet4,"/",jumlahip,"=",hasil ,"=",final_hasil," [Ambil Angka Sebelum Koma]") 
